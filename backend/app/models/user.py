...
for the Klymate AI application. Updated to include habit relationships.
"""
...
class User(BaseModel, SoftDeleteMixin, AuditMixin):
    ...
    baseline_footprint = Column(DECIMAL(10, 4), nullable=True)  # kg CO2 per year
    current_footprint = Column(DECIMAL(10, 4), nullable=True)  # kg CO2 per year
    total_co2_saved = Column(DECIMAL(12, 4), default=0, nullable=False)  # Total CO2 saved
