...
TIDB_DATABASE = "test"  # Using a separate test database

# SSL Certificate path
CA_CERT_PATH = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), "app", "core", "tidb-ca.pem"))
