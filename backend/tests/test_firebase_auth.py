...
class TestFirebaseAuth:
    ...
    @patch('app.utils.firebase_auth.auth.verify_id_token')
    ...
    @patch('app.utils.firebase_auth.auth.get_user')
    @patch.object(FirebaseConfig, 'get_app')
    ...
    @patch('app.utils.firebase_auth.auth.get_user_by_email')
    @patch.object(FirebaseConfig, 'get_app')
    ...
    @patch('app.utils.firebase_auth.auth.create_custom_token')
    @patch.object(FirebaseConfig, 'get_app')
